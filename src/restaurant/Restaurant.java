...
public class Restaurant {
    public static ArrayList<Menu> arrMenu = new ArrayList<Menu>();
    public static ArrayList<String> arrStringMenu = new ArrayList<String>();
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            if(arrStringMenu.contains(strMenuName)) {
                ...
                addMenu(strMenuName, dPrice, strCategory, strDate);
    ...
    public static void addMenu(String menuName, double price, String category, String menuDate)
    {
